 ...
 * @property-read $MsgType	语音为voice
 * @property-read $MediaId	语音消息媒体id，可以调用获取临时素材接口拉取数据。
 * @property-read $Format	语音格式，如amr，speex等数据。
 * @property-read $MsgId	消息id，64位整型
 * @property-read $Recognition	语音识别结果，UTF8编码
 * @property-read $MsgDataId	消息的数据ID（消息如果来自文章时才有）
 * @property-read $Idx	多图文时第几篇文章，从1开始（消息如果来自文章时才有）
 */
class VoiceMessageData extends MessageData
{
